...
SELECT BestellungId, ArtikelId, Menge, Gesamtpreis FROM BestellungArtikel WHERE (ArtikelId = @ArtikelId) AND (BestellungId = @BestellungId)";
    ...
    public partial class KassenbonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        Bestellung.BestellungId, Bestellung.PersonalId, Bestellung.Zeitpunkt, Bestellung.Gesamtpreis, Bestellung.Storniert, BestellungArtikel.Menge, 
...
ORDER BY Ausgabestelle.AusgabestelleId";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
...
WHERE     (Bestellung.BestellungId = ?) AND (Ausgabestelle.AusgabestelleId = ?)";
    ...
    public partial class BestellungenHistoryDetails_VTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        PersonalNr, Nachname, Vorname, Zeitpunkt, Bezeichnung, Einzelpreis, Menge, [BestellungArtikel.Gesamtpreis], [Bestellung.Gesamtpreis], BestellungId
FROM            BestellungenDetails_V
WHERE        (BestellungId = ?)
ORDER BY Zeitpunkt DESC";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
